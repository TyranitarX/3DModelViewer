...
public:
    ...
    void Draw(Shader *shader) {
        ...
        for (unsigned int i = 0; i < materials.size(); i++) {
            shader->setVec3("diffuseColor",
                            glm::vec3(materials[i].diffuseColor.r, materials[i].diffuseColor.g,
